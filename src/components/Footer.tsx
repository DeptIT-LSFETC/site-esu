...
export default function Footer() {
  ...
  return (
    <div className="flex flex-col md:flex-row font-semibold gap-4 justify-between px-20 bg-primary-0 h-fit w-full drop-shadow-sm bottom-0 py-8">
      <div>
      ...
      <div>
        <Link href="tel:0735149076"><div className={button}><FaPhone />Coordonator ESU: 0735 149 076</div></Link>
        <Link href="tel:0771494186"><div className={button}><FaPhone />Presedinte LSFETc: 0771 494 186</div></Link>
